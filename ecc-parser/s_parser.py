        ...
        while True:
            try:
               ...
               # print("select: r=%s w=%s e=%s" % (r,w,e))        # debug output to command line
                ...
                print("Raw Data received from Client:")
                print(msg)
                process_serial_data(msg)                 # Convert serial stream into dictionary and fetch data for each sensor
                publish_sensor_data()                    # Publish sensor data to MQTT broker
...
while True:
        try:
                ...
                threading._start_new_thread(on_new_client,(client, ip)) # Creating a new thread for handling client data
